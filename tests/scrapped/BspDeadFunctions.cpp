...
// void Bsp::repairSplits(wallNode* parent, wallNode* inserted)
// {
// 	if (parent == nullptr)
// 		return;

// 	geom::Wall* splitWalls = nullptr;
...
// 		inserted->wall = frontWall;

// 		wallNode*  backNode = new wallNode(backWall);
// 		insertRecursive(root, backNode);
// 	}
// 	if (splitWalls != nullptr)
// 	{

// 	}
// 	repairSplits(parent->frontChild, inserted)
// }

// void repairAllRecursive(wallNode* root, wallNode* inserted)
// {
// 	repairSplits(root, inserted);
// 	repairAllRecursive(root->frontChild, inserted);
// }
